document.addEventListener('DOMContentLoaded', function() {
    ...
    function addAnswerField(button) {
        ...
        answerForm.innerHTML = `
            ...
            <input type="text" name="answer_text_${questionIndex}_${answerIndex}" id="id_answer_text_${questionIndex}_${answerIndex}">
            <label for="id_is_correct_${questionIndex}_${answerIndex}">Правильный ответ:</label>
            <input type="checkbox" name="is_correct_${questionIndex}_${answerIndex}" id="id_is_correct_${questionIndex}_${answerIndex}">
        `;
